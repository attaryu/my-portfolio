    ...
    <main>
      ...
      <div>
        ...
        <section className="flex h-svh max-h-highest flex-col gap-10 px-8 pt-16 sm:items-center md:px-20 xl:h-dvh">
          <h1 className="mt-auto font-tusker-grotesk-medium text-7xl leading-tight md:text-6xl">
            HELLO, <br className="sm:hidden" />
            I'M ATTAR
          </h1>

          <div className="flex w-full flex-col justify-between py-8 md:mt-auto md:flex-row md:items-center md:py-5 md:text-lg">
        ...
        <section className="grid h-screen max-h-highest place-items-center px-8">
          <p className="text-xl leading-relaxed md:w-4/5 md:text-center md:text-3xl">
      ...
      <section className="w-full overflow-hidden py-14 md:py-32">
        <h2 className="-rotate-1 px-8 font-neue-montreal-medium text-3xl md:px-20 md:text-5xl">
        ...
        <div className="before:contents-[''] after:contents-[''] relative my-16 -rotate-1 before:pointer-events-none before:absolute before:-left-1 before:z-10 before:block before:h-full before:w-1/4 before:bg-gradient-to-l before:from-transparent before:to-white after:pointer-events-none after:absolute after:-right-1 after:top-0 after:z-10 after:block after:h-full after:w-1/4 after:bg-gradient-to-r after:from-transparent after:to-white md:my-20 before:xl:w-1/6 after:xl:w-1/6">
          <div className="w-full overflow-x-auto">
            <ul className="grid h-56 w-full min-w-[750px] grid-cols-7 grid-rows-2 place-items-center gap-x-6 md:h-72 md:w-[120vw] md:gap-x-8 xl:h-96">
              {logos.map((logo) => (
                <img
                  key={logo}
                  src={`/logo/${logo}-light.svg`}
                  alt={`${logo} logo`}
                  className="w-full rounded-lg border border-zinc-900 p-4 xl:rounded-xl xl:p-8"
                />
              ))}
            </ul>
          </div>
        ...
        <p className="mx-auto -rotate-1 px-8 text-right text-sm leading-tight sm:px-20 md:text-xl">
          <span className="md:inline-block md:w-3/4">
      ...
      <section>
        <p className="grid h-[150vh] max-h-[1600px] w-full grid-rows-2 place-items-center md:h-[200vh]">
          ...
          <span className="whitespace-nowrap font-tusker-grotesk-medium text-6xl md:text-[8rem] xl:text-[14rem]">
            INTO A REALITY
          </span>
        </p>
      </section>
      ...
      <section className="my-32 px-8 md:px-20">
        <h2 className="text-center font-neue-montreal-medium text-4xl xl:text-6xl">
      ...
      {/* offering project */}
      <section className="relative my-16 flex h-[80vh] max-h-highest flex-col overflow-hidden px-8 py-16 md:h-[60vh] md:p-20 xl:h-screen">
